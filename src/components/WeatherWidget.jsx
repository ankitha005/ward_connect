...
const WeatherWidget = () => {
  ...
  const getIcon = (condition, size = 16) => {
    ...
    if (c.includes("mist") || c.includes("fog"))
      return <Droplets className={`${cls} text-slate-400`} />;
    if (c.includes("cloud"))
  ...
  const getAqiInfo = (index) => {
    const map = {
      ...
      4: {
        ...
        desc: "Health effects for everyone.",
      },
      5: {
        text: "Very Poor",
        color: "bg-purple-600",
          ...
          >
                ...
                <div>
                  ...
                  <div className="flex items-end gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 text-sm capitalize font-medium mt-1">
            ...
            <div className="p-4 grid grid-cols-3 gap-3">
              {[
                ...
                {
                  icon: <Wind size={15} className="text-slate-400" />,
                  label: "Wind",
                  value: `${weatherData.windSpeed} km/h ${getWindDir(weatherData.windDeg)}`,
                },
                {
                ...
                {
                  icon: <Eye size={15} className="text-teal-400" />,
                  label: "Visibility",
                  value: `${weatherData.visibility} km`,
                },
                {
                  icon: <Cloud size={15} className="text-slate-400" />,
                  label: "Cloudiness",
                  value: `${weatherData.cloudiness}%`,
                },
                {
                  icon: <Thermometer size={15} className="text-red-400" />,
                  label: "Feels Like",
                ...
                <div
                  key={i}
                  className="bg-slate-50 rounded-xl p-2.5 flex flex-col items-center text-center gap-1"
                >
                  {item.icon}
            ...
            <div className="px-4 pb-4">
              <div
                className={`rounded-xl p-4 border ${
                  weatherData.aqiIndex <= 2
                    ? "bg-green-50 border-green-200"
                    : weatherData.aqiIndex === 3
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`text-xs font-black px-2.5 py-0.5 rounded-full text-white ${aqiInfo.color}`}
                  >
                    {aqiInfo.text}
                  </span>
                </div>

      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 w-72 bg-white border border-slate-200 p-5 rounded-3xl shadow-[0_20px_60px_rgba(249,115,22,0.3)]"
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-700 bg-slate-100 rounded-full p-1 transition-all"
              >
                <X size={16} />
              </button>
            </div>
            <p className="text-xs font-semibold text-slate-500 mb-4 leading-relaxed">
              Report an urgent issue or view the latest activities in Bengaluru
              Municipal Wards.
            </p>

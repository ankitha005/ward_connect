      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center py-20 px-4">
        ...
        >
          ...
          <p className="text-slate-600 font-medium leading-relaxed mb-8">
            Thank you for stepping up to serve your community. Our ward
            coordinator will contact you shortly regarding upcoming activities.
          </p>
          <Link
            to="/"
            className="inline-block bg-brand-orange text-white font-bold uppercase tracking-widest px-8 py-3.5 rounded-xl hover:shadow-lg hover:shadow-orange-200 transition-all"
          >
            Return Home
          </Link>
        </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 font-medium max-w-xl mx-auto">
            Become an active participant in your ward's development. Register as
            a volunteer to help drive positive change in your community.
          </p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={
              !form.fullName || !form.mobile || form.skills.length === 0
            }

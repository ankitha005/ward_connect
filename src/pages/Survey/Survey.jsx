    ...
    return (
      <div className="min-h-[calc(100vh-80px)] bg-slate-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <h2 className="text-3xl font-black text-slate-900 mb-3 uppercase tracking-tight">
            Feedback Captured
          </h2>
          <p className="text-slate-600 font-medium leading-relaxed mb-8">
            Thank you for participating! Your insights directly help our ward
            leadership prioritize the right projects.
          </p>
          <Link
            to="/"
            className="inline-block bg-brand-green text-white font-bold uppercase tracking-widest px-8 py-3.5 rounded-xl shadow-lg hover:shadow-green-200 transition-all"
          >
            Return Home
          </Link>
        </motion.div>
      ...
      <div className="max-w-3xl w-full mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 font-medium max-w-lg mx-auto">
            Your opinion matters. Take this 1-minute survey to help us shape the
            future development goals for our locality.
          </p>
        </div>
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-500 font-medium">
                    Please provide your basic details to validate this survey
                    response.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCitizenInfo((c) => ({ ...c, name: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <select
                      value={citizenInfo.ward}
                      onChange={(e) =>
                        setCitizenInfo((c) => ({ ...c, ward: e.target.value }))
                      }

  ...
  const schemes = [
    {
      ...
      category: "General",
      benefits:
        "Home loan subsidies up to ₹2.67 Lakhs for constructing, purchasing or renovating a house.",
      eligibility:
        "EWS (Annual income up to ₹3L), LIG (₹3L-₹6L), and MIG categories. Must not own a pucca house anywhere in India.",
      img: "https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&q=80&w=600",
      details:
        'PMAY-U ensures "Housing for All" by providing central assistance to implementing agencies through States/UTs. Beneficiaries receive a direct interest subsidy (CLSS) on housing loans from banks.',
      documents: [
        "Aadhaar Card",
        "Income Certificate",
        "PAN Card",
    ...
    },
    {
      ...
      category: "Farmers",
      benefits:
        "₹6,000 annual financial assistance deposited directly into bank accounts in 3 equal installments of ₹2,000.",
      eligibility:
        "All landholding farmer families across the country, subject to certain exclusion criteria related to higher income status.",
      img: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&q=80&w=600",
      details:
        "A central sector scheme with 100% funding from Government of India. It aims to supplement the financial needs of farmers in procuring various inputs to ensure proper crop health and appropriate yields.",
      documents: [
        "Aadhaar Card",
        "Land holding documents (RTC)",
        "Bank Passbook",
      ],
    ...
    },
    {
      ...
      category: "Women",
      benefits:
        "High-interest tax-free savings account (currently 8.2%) dedicated to the education and marriage expenses of girl children.",
      eligibility:
        "Parents or legal guardians of a girl child under 10 years of age. Maximum 2 accounts per family.",
      img: "https://images.unsplash.com/photo-1536640712247-c0502019a281?auto=format&fit=crop&q=80&w=600",
      details:
        'Part of the "Beti Bachao Beti Padhao" campaign, SSY allows deposits up to ₹1.5 Lakhs annually, qualifying for Section 80C tax benefits. The account matures 21 years after opening.',
      documents: [
        "Girl Child's Birth Certificate",
        "Parent's Identity & Address Proof",
      ],
    ...
    },
    {
      ...
      category: "Business",
      benefits:
        "Collateral-free loans up to ₹10 Lakhs categorized into Shishu (₹50K), Kishore (₹5L) and Tarun (₹10L).",
      eligibility:
        "Any Indian citizen running a non-corporate, non-farm small/micro enterprise involved in income generation.",
      img: "https://images.unsplash.com/photo-1454160249fb0-f19277636e08?auto=format&fit=crop&q=80&w=600",
      details:
        'MUDRA (Micro Units Development & Refinance Agency) supports the "Fund the Unfunded" initiative. It provides financial support to small manufacturing units, shopkeepers, fruit/vegetable sellers, and artisans.',
      documents: [
        "Aadhaar/PAN",
    ...
    },
    {
      ...
      category: "Health",
      benefits:
        "Cashless health insurance cover of up to ₹5 Lakhs per family per year for secondary and tertiary care hospitalization.",
      eligibility:
        "Vulnerable and low-income families identified by the Socio-Economic Caste Census (SECC) 2011 data.",
      img: "https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?auto=format&fit=crop&q=80&w=600",
      details:
        "The world's largest government-funded healthcare program. It covers 3 days of pre-hospitalization, 15 days of post-hospitalization expenses, diagnostics, and medicines.",
    ...
    },
    {
      ...
      category: "Business",
      benefits:
        "Initial working capital collateral-free loan of ₹10,000, which can be enhanced to ₹20,000 and ₹50k on timely repayment.",
      eligibility:
        "Street vendors, hawkers, and informal merchants operating in urban areas.",
      img: "https://images.unsplash.com/photo-1533900298318-6b8da08a523e?auto=format&fit=crop&q=80&w=600",
      details:
        "Launched during the pandemic to help street vendors resume their livelihoods. The scheme incentivizes digital transactions through cashback and provides high interest subsidies (7%).",
      documents: [
          ...
          >
            ...
            >
              ...
              <div className="h-48 md:h-64 relative shrink-0">
                ...
                <button
                  onClick={() => setSelectedScheme(null)}
                  className="absolute top-4 right-4 bg-black/40 hover:bg-black/70 text-white rounded-full p-2 transition-colors backdrop-blur"
                >
                  <X size={20} />
                </button>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 rounded-2xl p-6 text-center text-white">
                      ...
                      <p className="text-xs text-slate-400 font-medium mb-6">
                        You can apply directly online through the official
                        government portal.
                      </p>
                      <a
                        ...
                        className="w-full bg-primary hover:bg-orange-600 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-primary/20 block text-center"
                      >

...
import { ThumbsUp, MessageSquare, Share2, MoreHorizontal, User, Clock } from 'lucide-react'
    ...
    <div className="py-12 bg-slate-50 min-h-screen">
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-12 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-dark mb-2">Ward Announcements</h1>
            <p className="text-slate-500 font-medium text-sm">Stay connected with live updates from your representatives</p>
          </div>
        ...
        {announcements.length === 0 ? (
          <div className="text-center py-20 text-slate-400 font-semibold">No announcements yet.</div>
        ) : (
                ...
                <div className="px-6 pb-6 space-y-4">
                  ...
                  {post.img && (
                    <div className="rounded-2xl overflow-hidden shadow-inner">
                      <img src={post.img} alt="Update" className="w-full h-80 object-cover" />
                    </div>
                  )}
                </div>
